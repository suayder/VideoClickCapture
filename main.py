...
if __name__ == "__main__":
    ...
    parser.add_argument('--fps', default=40, type=int, help="fps ratio to show the video")
    parser.add_argument('--force-click', type=int, default=60, help="maximum frames that can elapse without require user click")
